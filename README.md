...
| **v1.3.x系列** | 5b3753e | UU远程自动检测与安装；KeyClient端口隔离 |
| | a8851c4 | 客户端帧率5fps→8fps，心跳150→240帧 |
| **v1.4.0** | 629f880 | 监控预览弹窗修复，大版本号更新 |
| **v1.5.0** | bd8e9a7 | 移除stopHQ静态帧捕获 |
| **v1.6.0** | 8c51328 | 统一截图频率8fps；动态sleep精确控制 |
| | 4e7d63a | 增加MAC地址识别，设备重装自动继承 |
| **v1.7.x系列** | b877e63 | 服务端globalHQ引用计数重构 |
| | 38059c9 | 统一降帧至**6fps**稳定 |
| | 3578e3f | 统一所有截图质量为30，优化画质体积平衡 |
...
| **MUMU v35** | 2ddf5c6 | HID报告结构分析 |
| **MUMU v38** | 69a21c4 | Qt5弹窗自动点击（BM_CLICK）|
| **MUMU v49** | a1bc897 | 自动注入+二次检测+命名管道 |
