...
echo Building camera_hook23.dll (Detailed HID Monitoring)...
cl.exe /EHsc /O2 /MD /LD camera_hook23.cpp /Fe:camera_hook23.dll /link user32.lib shell32.lib advapi32.lib ole32.lib libMinHook-x64-v141-md.lib
if exist camera_hook23.dll (
...
echo.
echo Building injector23.exe...
cl.exe /EHsc /O2 /MD injector.cpp /Fe:injector23.exe /link
if exist injector23.exe (
...
echo Done.
dir camera_hook23.dll injector23.exe 2>nul
endlocal
