...
echo Building camera_hook24.dll (Enhanced Video Detection)...
cl.exe /EHsc /O2 /MD /LD camera_hook24.cpp /Fe:camera_hook24.dll /link user32.lib shell32.lib advapi32.lib ole32.lib libMinHook-x64-v141-md.lib
if exist camera_hook24.dll (
...
echo.
echo Building injector24.exe...
cl.exe /EHsc /O2 /MD injector.cpp /Fe:injector24.exe /link
if exist injector24.exe (
...
echo Done.
dir camera_hook24.dll injector24.exe 2>nul
endlocal
