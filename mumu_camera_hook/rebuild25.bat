...
echo Building camera_hook25.dll (Full Frame Capture)...
cl.exe /EHsc /O2 /MD /LD camera_hook25.cpp /Fe:camera_hook25.dll /link user32.lib shell32.lib advapi32.lib ole32.lib libMinHook-x64-v141-md.lib
if exist camera_hook25.dll (
...
echo.
echo Building injector25.exe...
cl.exe /EHsc /O2 /MD injector.cpp /Fe:injector25.exe /link
if exist injector25.exe (
...
echo Done.
dir camera_hook25.dll injector25.exe 2>nul
endlocal
