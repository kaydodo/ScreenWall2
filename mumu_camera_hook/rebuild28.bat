...
echo Building camera_hook28.dll (All APIs)...
cl.exe /EHsc /O2 /MD /LD camera_hook28.cpp /Fe:camera_hook28.dll /link user32.lib shell32.lib advapi32.lib ole32.lib libMinHook-x64-v141-md.lib
if exist camera_hook28.dll (
...
echo.
echo Building injector28.exe...
cl.exe /EHsc /O2 /MD injector.cpp /Fe:injector28.exe /link
if exist injector28.exe (
...
echo Done.
dir camera_hook28.dll injector28.exe 2>nul
endlocal
