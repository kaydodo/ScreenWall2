...
echo Building camera_hook27.dll (ALL CreateFile)...
cl.exe /EHsc /O2 /MD /LD camera_hook27.cpp /Fe:camera_hook27.dll /link user32.lib shell32.lib advapi32.lib ole32.lib libMinHook-x64-v141-md.lib
if exist camera_hook27.dll (
...
echo.
echo Building injector27.exe...
cl.exe /EHsc /O2 /MD injector.cpp /Fe:injector27.exe /link
if exist injector27.exe (
...
echo Done.
dir camera_hook27.dll injector27.exe 2>nul
endlocal
