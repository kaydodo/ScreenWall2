...
echo Building camera_hook17.dll (logging mode)...
cl.exe /EHsc /O2 /MD /LD camera_hook17.cpp /Fe:camera_hook17.dll /link user32.lib shell32.lib advapi32.lib ole32.lib libMinHook-x64-v141-md.lib
if exist camera_hook17.dll (
...
echo.
echo Building injector17.exe...
cl.exe /EHsc /O2 /MD injector.cpp /Fe:injector17.exe /link
if exist injector17.exe (
...
echo Done.
dir camera_hook17.dll injector17.exe 2>nul
endlocal
