...
echo Building camera_hook26.dll (Log ALL CreateFile)...
cl.exe /EHsc /O2 /MD /LD camera_hook26.cpp /Fe:camera_hook26.dll /link user32.lib shell32.lib advapi32.lib ole32.lib libMinHook-x64-v141-md.lib
if exist camera_hook26.dll (
...
echo.
echo Building injector26.exe...
cl.exe /EHsc /O2 /MD injector.cpp /Fe:injector26.exe /link
if exist injector26.exe (
...
echo Done.
dir camera_hook26.dll injector26.exe 2>nul
endlocal
