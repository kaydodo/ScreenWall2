...
echo Building camera_hook20.dll (DirectShow tracking)...
cl.exe /EHsc /O2 /MD /LD camera_hook20.cpp /Fe:camera_hook20.dll /link user32.lib shell32.lib advapi32.lib ole32.lib libMinHook-x64-v141-md.lib
if exist camera_hook20.dll (
...
echo.
echo Building injector20.exe...
cl.exe /EHsc /O2 /MD injector.cpp /Fe:injector20.exe /link
if exist injector20.exe (
...
echo Done.
dir camera_hook20.dll injector20.exe 2>nul
endlocal
