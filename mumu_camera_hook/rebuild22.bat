...
echo Building camera_hook22.dll (DirectShow Frame Tracking)...
cl.exe /EHsc /O2 /MD /LD camera_hook22.cpp /Fe:camera_hook22.dll /link user32.lib shell32.lib advapi32.lib ole32.lib libMinHook-x64-v141-md.lib strmiids.lib quartz.lib
if exist camera_hook22.dll (
...
echo.
echo Building injector22.exe...
cl.exe /EHsc /O2 /MD injector.cpp /Fe:injector22.exe /link
if exist injector22.exe (
...
echo Done.
dir camera_hook22.dll injector22.exe 2>nul
endlocal
