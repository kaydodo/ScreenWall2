...
echo Building camera_hook30.dll (HID Hook)...
cl.exe /EHsc /O2 /MD /LD camera_hook30.cpp /Fe:camera_hook30.dll /link user32.lib shell32.lib advapi32.lib ole32.lib libMinHook-x64-v141-md.lib hid.lib
if exist camera_hook30.dll (
...
echo.
echo Building injector30.exe...
cl.exe /EHsc /O2 /MD injector.cpp /Fe:injector30.exe /link
if exist injector30.exe (
...
echo Done.
dir camera_hook30.dll injector30.exe 2>nul
endlocal
