...
echo Building camera_hook18.dll (logging mode)...
cl.exe /EHsc /O2 /MD /LD camera_hook18.cpp /Fe:camera_hook18.dll /link user32.lib shell32.lib advapi32.lib ole32.lib libMinHook-x64-v141-md.lib
if exist camera_hook18.dll (
...
echo.
echo Building injector18.exe...
cl.exe /EHsc /O2 /MD injector.cpp /Fe:injector18.exe /link
if exist injector18.exe (
...
echo Done.
dir camera_hook18.dll injector18.exe 2>nul
endlocal
