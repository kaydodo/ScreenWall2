...
echo Building camera_hook29.dll (SetupDi Hook)...
cl.exe /EHsc /O2 /MD /LD camera_hook29.cpp /Fe:camera_hook29.dll /link user32.lib shell32.lib advapi32.lib ole32.lib setupapi.lib libMinHook-x64-v141-md.lib
if exist camera_hook29.dll (
...
echo.
echo Building injector29.exe...
cl.exe /EHsc /O2 /MD injector.cpp /Fe:injector29.exe /link
if exist injector29.exe (
...
echo Done.
dir camera_hook29.dll injector29.exe 2>nul
endlocal
