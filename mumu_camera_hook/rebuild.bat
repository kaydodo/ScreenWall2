...
echo Building camera_hook16.dll (logging mode)...
cl.exe /EHsc /O2 /MD /LD camera_hook.cpp /Fe:camera_hook16.dll /link user32.lib shell32.lib advapi32.lib ole32.lib libMinHook-x64-v141-md.lib
if exist camera_hook16.dll (
...
echo.
echo Building injector16.exe...
cl.exe /EHsc /O2 /MD injector.cpp /Fe:injector16.exe /link
if exist injector16.exe (
...
echo Done.
dir camera_hook16.dll injector16.exe 2>nul
endlocal
