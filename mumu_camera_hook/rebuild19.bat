...
echo Building camera_hook19.dll...
cl.exe /EHsc /O2 /MD /LD camera_hook19.cpp /Fe:camera_hook19.dll /link user32.lib shell32.lib advapi32.lib ole32.lib libMinHook-x64-v141-md.lib
if exist camera_hook19.dll (
...
echo.
echo Building injector19.exe...
cl.exe /EHsc /O2 /MD injector.cpp /Fe:injector19.exe /link
if exist injector19.exe (
...
echo Done.
dir camera_hook19.dll injector19.exe 2>nul
endlocal
